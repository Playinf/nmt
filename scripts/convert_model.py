...
def get_rnnsearch_keys():
    ...
    keys.append("rnnsearch/source_embedding")
    keys.append("rnnsearch/source_embedding_bias")
    keys.append("rnnsearch/target_embedding")
    keys.append("rnnsearch/target_embedding_bias")
    ...
    keys.append("rnnsearch/initial/matrix_0")
    keys.append("rnnsearch/initial/bias")
    ...
    keys.append("rnnsearch/maxout/matrix_0")
    keys.append("rnnsearch/maxout/matrix_1")
    keys.append("rnnsearch/maxout/matrix_2")
    keys.append("rnnsearch/maxout/bias")
    keys.append("rnnsearch/deepout/matrix_0")
    keys.append("rnnsearch/logits/matrix_0")
    keys.append("rnnsearch/logits/bias")
